...
<form action="write" method="post">
	<div class="container mt-40 center">
		...
		<div class="row left">
			<input class="input w-100" type="text" name="qnaTitle" required placeholder="문의글 제목을 입력해 주세요.">
		</div>
		
		<div class="row left">
			<textarea class="input w-100" name="qnaContents" rows="20" required placeholder="문의 내용을 입력하세요."></textarea>
		</div>
