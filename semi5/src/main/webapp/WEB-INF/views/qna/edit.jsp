...
<jsp:include page="/WEB-INF/views/template/header.jsp">
	<jsp:param value="문의 수정" name="title"/>
</jsp:include>
...
<div class="container mt-40">
	...
	<div class="row left">
		<input class="input w-100" type="text" name="qnaTitle" required value="${qnaDto.qnaTitle}" placeholder="제목을 입력해 주세요." autocomplete="off">
	</div>
	
	<div class="row left">
		<textarea class="input w-100" name="qnaContents" rows="10" required placeholder="내용을 입력하세요." value="${qnaDto.qnaContents}">${qnaDto.qnaContents}</textarea>
	</div>
