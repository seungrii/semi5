...
<jsp:include page="/WEB-INF/views/user-login-template/loginHeader.jsp">
	...
	<section class="w-980">
		...
		<form>
        	...
        	<div class="row">
            	<textarea class="w-100 fix-size" rows="20" readonly>제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea>
        	...
        	<div class="row">
            	<label class="w-50">
                	<input type="checkbox" name="agree" value="type1">
                	<span>동의합니다</span>
                	<span>*</span>
            	</label>
        	</div>
        	...
        	<div class="row">
            	<textarea class="w-100 fix-size" rows="20" readonly>개인정보처리방침
...
경찰청 사이버테러대응센터 (www.ctrc.go.kr / 02-392-0330)</textarea>
        	...
        	<div class="row">
            	<label class="w-50">
                	<input type="checkbox" name="agree" value="type2">
                	<span>동의합니다</span>
                	<span>*</span>
            	</label>
        	</div>
        	...
        	<div class="row">
            	<textarea class="w-100 fix-size textarea3" rows="20" readonly>VIC는 개인정보보호법 등에 관한 법률 등 관계법령에 따라 광고성 정보를 전송하
...
용목적에 따른 혜택의 제한이 있을 수 있습니다. 그 밖에 금융 거래와 관련된 불이익은 없습니다.
	...
	- 전송내용
		발송되는 마케팅 정보는 수신자에게 VIC가 운영하는 서비스에
	...
	- 개인정보 이용 상세내용
		...
		휴대전화번호, 이메일주소 혜택 정보, 각종 이벤트 정보, 상품 정보, 신규 서비스 안내 등 광고 성 정보 제공
	- 개인정보 보유 및 이용 기간
		마케팅 활용 동의일로부터 회원 탈퇴 또는 마케팅 동의 철회 시까지 보유 및 이용</textarea>
        	</div>
        	<div class="row">
            	<label class="w-50">
                	<input type="checkbox" name="agree" value="type3">
                	<span>동의합니다</span>
            	</label>
        	</div>
        
        	<div class="row mt-30 right">
            	<label>
                	<input type="checkbox">
                	<span>전체 선택</span>
            	</label>
        	</div>
        	<div class="row mt-30 mb-50 right">
        		<button type="button" class="btn btn-neutral">이전으로 이동</button>
            	<button type="submit" class="btn btn-positive" >다음 단계로 이동</button>
        	</div>
		</form>
	</section>
