<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:include page="/WEB-INF/views/user-login-template/joinHeader.jsp">
	...
	- 개인정보 보유 및 이용 기간
		마케팅 활용 동의일로부터 회원 탈퇴 또는 마케팅 동의 철회 시까지 보유 및 이용</textarea>
            ...
            <div class="row mt-30 mb-50 right">
                <button type="button" class="btn btn-neutral">메인으로 이동</button>
                <button type="button" class="btn btn-positive next">다음 단계로 이동</button>
            </div>
    	</div>
